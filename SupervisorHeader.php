                        ...
                        <div class="profile">
                            <div class="profile-data">
                                ...
                                <div class="profile-data-name">
                                    ...
                                    <br>
                                    <ul>
                                    <li style="text-align: left;" <?php echo basename($_SERVER['PHP_SELF']) == 'SupervisorProfile.php' ? 'class="active"' : ''; ?>>
    <a href="SupervisorProfile.php" style="font-size: 16px;">
        <span><i class="fa fa-user" aria-hidden="true"></i></span>
        <span class="xn-text">Supervisor Profile</span>
    </a>
</li>

<li style="text-align: left;" <?php echo basename($_SERVER['PHP_SELF']) == 'StudentData.php' ? 'class="active"' : ''; ?>>
    <a href="StudentData.php" style="font-size: 16px;">
        <span><i class="fa fa-file" aria-hidden="true"></i></span>
        <span class="xn-text">Students Data</span>
    </a>
</li>
