    ...
    <body>
        ...
        <div class="login-container">
			...
			<div class="login-body">
                    <div class="login-title"><strong>Welcome</strong>, Please Register as Supervisor</div>
                    <form action="api/SupervisorProfileRegister.php" class="form-horizontal" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-md-6">
                            <input type="text" id="facultyNumber" name="facultyNumber" class="form-control" required placeholder="Faculty Id Number"/>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-6">
                             <input type="text" class="form-control" id="username" name="username" placeholder="Username will be used for Login" required />
                        </div>
						<div class="col-md-6">
