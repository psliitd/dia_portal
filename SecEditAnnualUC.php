...
<option value="FY2027-28" <?php if(isset($_GET['year']) && $_GET['year'] == 'FY2027-28') echo 'selected'; ?>>FY2027-28</option>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    if (  isset($year)) {
                        ...
                        echo "You have selected  year <span style='color: black;'> $year</span>";
                        echo "</div>";
                    }
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<tr>";
                            echo "<td>{$iitName}</td>";
                            echo "<td><button class='uc-upload-btn btn btn-primary' data-iit-id='" . $iitName . "-"  . $year . "' onclick='openPopup()'>UC Upload</button></td>";
                    
                            if (  isset($year)) {
                                echo "<td><a class='uc-download-link' href='api/sec_download_annual_uc.php?iit_id=" . $iitName . "-"  . $year . "'>UC Download</a></td>";
                            }  
    ...
    <div class="overlay" id="overlay"></div>
        <div class="popup" id="popup">
            <form action="api/upload_annual_uc_sec.php" method="post" enctype="multipart/form-data">
