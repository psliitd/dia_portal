...
?>
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li class="active">Districts Indicator</li>
                </ul>
                <!-- END BREADCRUMB -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
							...
							<div class="panel-heading">
                                    <h3 class="panel-title">Districts Indicator Data</h3>
                                    <ul class="panel-controls">
                                        <li><a href="#" class="panel-refresh"><span class="fa fa-refresh"></span></a></li>
                                    </ul>
                                </div>
								<a href="DownloadDistrictIndicator.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-info">Download Template</button></a><a href="UploadDistrictIndicator.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-success">Upload Data</button></a> 
    ...
    <!-- START SCRIPTS -->
		...
		function delete_entry(temp_id){
			post({uid: temp_id} ,"api/DistrictDelete.php");
		}

		function view_entry(temp_id){
			post({year: temp_id} ,"DistrictIndicatorView.php");
		}
