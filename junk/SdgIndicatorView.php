...
?>
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li class="active">Sdg Data View</li>
                </ul>
                <!-- END BREADCRUMB -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
							...
							<div class="panel-heading">
                                    <h3 class="panel-title">Sdg Data View</h3>
                                 ...
                                 <div class="table-responsive">
                                    <table id="export_table" class="table datatable">
										<thead>
                                            <tr>
										<?php
											$query = "SELECT id,indicator FROM targets WHERE 1";
											$result = mysqli_query($con,$query);
											$dict = array();
											while($row = mysqli_fetch_array($result))
											{
												$dict[$row['id']] = $row['indicator']; 
											}
											
											$tableName = "sdgindicator_".$_POST['year'];
											...
											while($row = mysqli_fetch_assoc($res)){
												...
												if(array_key_exists($row['Field'],$dict)){
													echo "<th>".$dict[$row['Field']]."</th>";
												}
												else{
