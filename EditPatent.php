...
$uid = $_POST['uid'];
$query = "SELECT * FROM patent WHERE uid='$uid'";
$result = mysqli_query($con,$query);
$numrows = mysqli_num_rows($result);
if($numrows==1){
	$row = mysqli_fetch_assoc($result);
	$patent_title = $row['patent_title'];
	$patent_link = $row['patent_link'];
	$patent_grade = $row['patent_grade'];
}
else{
...
?>
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li class="active">Edit Patent</li>
                </ul>
                <!-- END BREADCRUMB -->
                 ...
                 <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="api/EditPatent.php" method="POST" class="form-horizontal" enctype = "multipart/form-data">
                            <div class="panel panel-default">
                               <div class="panel-body">
                                    <p>Fill this form to edit patent.</p>
                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="title" name="title" value="<?php echo $patent_title ?>" required />
                                                    </div>
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" id="link" name="link" value="<?php echo $patent_link ?>"required />
                                                    </div>
