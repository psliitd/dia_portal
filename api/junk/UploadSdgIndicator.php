...
if (isset($_POST["submit"]) and isset($_POST["year"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
		...
		$uniqueId = uniqid();
		$query = "INSERT INTO sdg_year VALUES ('".$uniqueId."','".$_POST['year']."')";
		...
		$query = "CREATE TABLE IF NOT EXISTS ".$tableName."( sdgindicator  varchar(255))";
		//echo $query;
		mysqli_query($con, $query);
		...
		header("Location:../SdgIndicator.php");
    }
}
?>