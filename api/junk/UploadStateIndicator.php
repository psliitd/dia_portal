...
if (isset($_POST["submit"]) and isset($_POST["year"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
		...
		$uniqueId = uniqid();
		$query = "INSERT INTO state_year VALUES ('".$uniqueId."','".$_POST['year']."')";
		...
		$query = "CREATE TABLE IF NOT EXISTS ".$tableName."( stateindicator  varchar(255))";
		...
		header("Location:../StateIndicator.php");
    }
}
?>