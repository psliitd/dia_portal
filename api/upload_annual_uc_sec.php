...
$sqlCreateTable = "CREATE TABLE IF NOT EXISTS SecFilesUploadSAnnualUC (
...
$targetDir = $_SERVER['DOCUMENT_ROOT'] . "secuploadsannualuc/";
...
if (isset($_POST["submit"])) {
    ...
    if (in_array($fileType, $allowTypes)) {
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $targetFilePath)) {
            ...
            $stmt = $con->prepare("INSERT INTO  SecFilesUploadSAnnualUC (filename, filepath, iit_name) VALUES (?, ?, ?)");
            ...
            if ($stmt->execute()) {
                ...
                echo "<script>setTimeout(function(){ window.location.href = '../SecEditAnnualUC.php'; }, 2000);</script>";
